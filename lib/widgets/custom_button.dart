...
enum CustomButtonType { primary, secondary, delete, confirm, cancel, formField, flat, camera, document, faded, outlined, deleteOutlined }

Map<CustomButtonType, Color> _customButtonColors = {
  CustomButtonType.primary: Palette.primaryColor,
  CustomButtonType.secondary: Colors.red,
  ...
  CustomButtonType.camera: Colors.grey.shade400,
  CustomButtonType.document: Colors.grey.shade400,
...
Map<CustomButtonType, Color> _customButtonTextColors = {
  ...
  CustomButtonType.outlined: Colors.red,
...
class CustomButton extends StatelessWidget {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: _customButtonType == CustomButtonType.deleteOutlined
              ? Border.all(color: Palette.dangerColor)
  ...
  Widget _childBuilder(BuildContext context) {
    if (_haveChild!) {
      ...
      return Text(_text, style: const TextStyle(color: Palette.dangerColor, fontWeight: FontWeight.bold));
